...
- [ x] Find and fix all the syntax issues in the file
  x - There are commented out hints for you to find the CSS rules with incorrect syntax
  x - When running tests, the failed test message contains the CSS file line number of the rule that was tested.
